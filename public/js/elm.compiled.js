	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('home-page-header-wrapper')
					]),
				_List_fromArray(
					[author$project$Components$Header$viewHeader])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{ar: author$project$Main$initialModel, az: author$project$Main$update, aB: author$project$Main$view});
